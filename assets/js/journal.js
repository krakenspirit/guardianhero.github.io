...
function (t, e) {
    ...
    if (u.stringify = u.stringify || u.encode, u.parse = u.parse || u.decode, void 0 !== c.init) throw new Error("History.js Core has already been loaded...");
    c.init = function (t) {
        return void 0 !== c.Adapter && (void 0 !== c.initCore && c.initCore(), void 0 !== c.initHtml4 && c.initHtml4(), !0)
    }, c.initCore = function (f) {
        if (void 0 !== c.initCore.initialized) return !1;
        if (c.initCore.initialized = !0, c.options = c.options || {}, c.options.hashChangeInterval = c.options.hashChangeInterval || 100, c.options.safariPollInterval = c.options.safariPollInterval || 500, c.options.doubleCheckInterval = c.options.doubleCheckInterval || 500, c.options.disableSuid = c.options.disableSuid || !1, c.options.storeInterval = c.options.storeInterval || 1e3, c.options.busyDelay = c.options.busyDelay || 250, c.options.debug = c.options.debug || !1, c.options.initialTitle = c.options.initialTitle || n.title, c.options.html4Mode = c.options.html4Mode || !1, c.options.delayInit = c.options.delayInit || !1, c.intervalList = [], c.clearAllIntervals = function () {
                ...
                return s ? (s.value += o + "\n-----\n", s.scrollTop = s.scrollHeight - s.clientHeight) : e || d(o), !0
            }, c.getInternetExplorerMajorVersion = function () {
                var t;
                return c.getInternetExplorerMajorVersion.cached = void 0 !== c.getInternetExplorerMajorVersion.cached ? c.getInternetExplorerMajorVersion.cached : function () {
                ...
                var t;
                return c.isInternetExplorer.cached = void 0 !== c.isInternetExplorer.cached ? c.isInternetExplorer.cached : Boolean(c.getInternetExplorerMajorVersion())
                ...
                var t, e, i;
                return i = ((c.getState(!1, !1) || {}).url || c.getLocationHref()).replace(/\/+$/, "").replace(/[^\/]+$/, (function (t, e, i) {
                    return /\./.test(t) ? t : t + "/"
                }))
            }, c.getBasePageUrl = function () {
                var t;
                return c.getLocationHref().replace(/[#\?].*/, "").replace(/[^\/]+$/, (function (t, e, i) {
                    return /[^\/]$/.test(t) ? "" : t
                })).replace(/\/+$/, "") + "/"
            }, c.getFullUrl = function (t, e) {
                var i = t,
                    n = t.substring(0, 1);
                return e = void 0 === e || e, /[a-z]+\:\/\//.test(t) || (i = "/" === n ? c.getRootUrl() + t.replace(/^\/+/, "") : "#" === n ? c.getPageUrl().replace(/#.*/, "") + t : "?" === n ? c.getPageUrl().replace(/[\?#].*/, "") + t : e ? c.getBaseUrl() + t.replace(/^(\.\/)+/, "") : c.getBasePageUrl() + t.replace(/^(\.\/)+/, "")), i.replace(/\#$/, "")
                ...
                return !i && e && (i = c.createStateObject()), t && ((i = c.cloneObject(i)).url = i.cleanUrl || i.url), i
            }, c.getIdByState = function (t) {
                var e = c.extractId(t.url),
                    i;
                if (!e)
                    if (i = c.getStateString(t), void 0 !== c.stateToId[i]) e = c.stateToId[i];
                    else if (void 0 !== c.store.stateToId[i]) e = c.store.stateToId[i];
                else {
                    for (; e = (new Date).getTime() + String(Math.random()).replace(/\D/g, ""), void 0 !== c.idToState[e] || void 0 !== c.store.idToState[e];);
                    c.stateToId[i] = e, c.idToState[e] = t
                }
                return e
            }, c.normalizeState = function (t) {
                var e, i;
                return t && "object" == typeof t || (t = {}), void 0 !== t.normalized ? t : (t.data && "object" == typeof t.data || (t.data = {}), (e = {}).normalized = !0, e.title = t.title || "", e.url = c.getFullUrl(t.url ? t.url : c.getLocationHref()), e.hash = c.getShortUrl(e.url), e.data = c.cloneObject(t.data), e.id = c.getIdByState(e), e.cleanUrl = e.url.replace(/\??\&_suid.*/, ""), e.url = e.cleanUrl, i = !c.isEmptyObject(e.data), (e.title || i) && !0 !== c.options.disableSuid && (e.hash = c.getShortUrl(e.url).replace(/\??\&_suid.*/, ""), /\?/.test(e.hash) || (e.hash += "?"), e.hash += "&_suid=" + e.id), e.hashedUrl = c.getFullUrl(e.hash), (c.emulated.pushState || c.bugs.safariPoll) && c.hasUrlDuplicate(e) && (e.url = e.hashedUrl), e)
                ...
                var i;
                return t = String(t), c.idToState[t] || c.store.idToState[t] || e
            }, c.getStateString = function (t) {
                var e, i, n;
                return i = {
                    data: (e = c.normalizeState(t)).data,
                    title: t.title,
                    url: t.url
                }, n = u.stringify(i)
            }, c.getStateId = function (t) {
                var e, i;
                return i = (e = c.normalizeState(t)).id
            }, c.getHashByState = function (t) {
                var e, i;
                return i = (e = c.normalizeState(t)).hash
                ...
                var i = null,
                    n, s;
                return e = e || !1, (n = c.extractId(t)) && (i = c.getStateById(n)), i || (s = c.getFullUrl(t), (n = c.getIdByUrl(s) || !1) && (i = c.getStateById(n)), !i && e && !c.isTraditionalAnchor(t) && (i = c.createStateObject(null, null, s))), i
            }, c.getIdByUrl = function (t) {
                var i;
                return c.urlToId[t] || c.store.urlToId[t] || e
                ...
                var e = !1,
                    i;
                return e = (i = c.extractState(t.url)) && i.id !== t.id
            }, c.storeState = function (t) {
                return c.urlToId[t.url] = t.id, c.storedStates.push(c.cloneObject(t)), t
            }, c.isLastSavedState = function (t) {
                var e = !1,
                    i, n, s;
                return c.savedStates.length && (e = (i = t.id) === (s = (n = c.getLastSavedState()).id)), e
            }, c.saveState = function (t) {
                return !c.isLastSavedState(t) && (c.savedStates.push(c.cloneObject(t)), !0)
            }, c.getStateByIndex = function (t) {
                var e = null;
                return e = void 0 === t ? c.savedStates[c.savedStates.length - 1] : t < 0 ? c.savedStates[c.savedStates.length + t] : c.savedStates[t]
                ...
                var i, s;
                return !1 !== e && c.busy() ? (c.pushQueue({
                    scope: c,
                    callback: c.setHash,
                    args: arguments,
                    queue: e
                }), !1) : (c.busy(!0), (i = c.extractState(t, !0)) && !c.emulated.pushState ? c.pushState(i.data, i.title, i.url, !1) : c.getHash() !== t && (c.bugs.setHash ? (s = c.getPageUrl(), c.pushState(null, null, s + "#" + t, !1)) : n.location.hash = t), c)
                ...
                var e = t.title,
                    i;
                e || (i = c.getStateByIndex(0)) && i.url === t.url && (e = i.title || c.options.initialTitle);
                try {
                    n.getElementsByTagName("title")[0].innerHTML = e.replace("<", "&lt;").replace(">", "&gt;").replace(" & ", " &amp; ")
                } catch (t) {}
                return n.title = e, c
            }, c.queues = [], c.busy = function (t) {
                if (void 0 !== t ? c.busy.flag = t : void 0 === c.busy.flag && (c.busy.flag = !1), !c.busy.flag) {
                    a(c.busy.timeout);
                    var e = function () {
                        var t, i, n;
                        if (!c.busy.flag)
                            for (t = c.queues.length - 1; t >= 0; --t) 0 !== (i = c.queues[t]).length && (n = i.shift(), c.fireQueueItem(n), c.busy.timeout = r(e, c.options.busyDelay))
                    };
                ...
                return "function" == typeof t && (t = {
                    callback: t
                }), void 0 !== e && (t.queue = e), c.busy() ? c.pushQueue(t) : c.fireQueueItem(t), c
                ...
                var e = c.extractState(c.getLocationHref()),
                    i;
                if (!c.isLastSavedState(e)) return (i = e) || (i = c.createStateObject()), c.Adapter.trigger(t, "popstate"), c
            }, c.back = function (t) {
                return !1 !== t && c.busy() ? (c.pushQueue({
                    scope: c,
                    callback: c.back,
                    args: arguments,
                    queue: t
            ...
            if (!1 !== s && c.busy()) return c.pushQueue({
                scope: c,
        ...
        c.Adapter.bind(t, "unload", c.clearAllIntervals), c.saveState(c.storeState(c.extractState(c.getLocationHref(), !0))), o && (c.onUnload = function () {
            ...
            for (e in t.idToState = t.idToState || {}, t.urlToId = t.urlToId || {}, t.stateToId = t.stateToId || {}, c.idToState) c.idToState.hasOwnProperty(e) && (t.idToState[e] = c.idToState[e]);
...
function (t, e) {
    ...
    function o(e) {
        if (s(), "string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
            ...
            var C = t(o.height);
            return !1 !== C && (a.height = C + (x ? 0 : m + w)), a.innerWidth = a.width - (g + _), a.innerHeight = a.height - (m + w), a.outerWidth = a.width + v, a.outerHeight = a.height + y, a
        }
    }
...
function (t, e) {
    ...
    return n._resetLayout = function () {
        ...
        for (var h, u = (this._getOption("originTop") ? n.top : n.bottom) + i.outerHeight, d = a; l >= d; d++) this.colYs[d] = Math.max(u, this.colYs[d])
        ...
        c = {
            dom: function () {
                ...
                if (t(this.element).addClass("fluidbox-closed").wrapInner(e).find("img").first().css({
                        opacity: 1
                    }).addClass("fluidbox_thumb").after('<div class="fluidbox_ghost" />'), this.settings.loader) {
                    var i = t("<div />", {
                        class: "fluidbox_loader",
                        css: {
                            zIndex: 2
                        }
                    });
                    t(this.element).find(".fluidbox_wrap").append(i)
                }
            },
            prepareFb: function () {
                var e = this,
            ...
            measure: {
                ...
                fbElements: function () {
                    var e = this,
                        i = t(this.element),
                        n = i.find("img").first(),
                        s = i.find(".fluidbox_ghost"),
                        o = i.find(".fluidbox_wrap");
    ...
    t.extend(s.prototype, {
        init: function () {
            ...
            if (c.measure.viewport(), (!e.instanceData || !e.instanceData.initialized) && i.is("a") && 1 === i.children().length && (i.children().is("img") || i.children().is("picture") && 1 === i.find("img").length) && "none" !== i.css("display") && "none" !== i.children().css("display") && "none" !== i.parents().css("display")) {
                i.removeClass("fluidbox-destroyed"), e.instanceData = {}, e.instanceData.initialized = !0, e.instanceData.originalNode = i.html(), h += 1, e.instanceData.id = h, i.addClass("fluidbox_instance-" + h), i.addClass("fluidbox-initialized"), c.dom.call(e), i.trigger("init.fluidbox");
                var s = new Image;
        ...
        open: function () {
            ...
            s.css({
                ...
                opacity: 1
            }), c.measure.fbElements.call(e), e.settings.immediateOpen ? (i.addClass("fluidbox-opened fluidbox-loaded").find(".fluidbox_wrap").css({
                zIndex: e.settings.stackIndex + e.settings.stackIndexDelta
            }), i.trigger("openstart.fluidbox"), e.compute(), n.css({
                opacity: 0
            }), t(".fluidbox_overlay").css({
                opacity: 1
            }), s.one(d, (function () {
                ...
                return i.trigger("imageloaddone.fluidbox"), i.removeClass("fluidbox-loading").addClass("fluidbox-opened fluidbox-loaded").find(".fluidbox_wrap").css({
                    zIndex: e.settings.stackIndex + e.settings.stackIndexDelta
        ...
        close: function (e) {
            var i = this,
                s = t(this.element),
                o = s.find("img").first(),
                r = s.find(".fluidbox_ghost"),
                a = s.find(".fluidbox_wrap"),
                l = s.find(".fluidbox_overlay"),
                h = t.extend(null, {
                    error: !1
                }, e);
        ...
        destroy: function () {
            ...
            this.unbind(), t.data(this.element, "plugin_" + r, null), t(this.element).removeClass((function (t, e) {
                return (e.match(/(^|\s)fluidbox[-|_]\S+/g) || []).join(" ")
...
function (t, e, i, n) {
    ...
    (function () {
        return !!s("transition")
    })() && (t.support.transition = new String(o("transition")), t.support.transition.end = l.transition.end[t.support.transition]), c() && (t.support.animation = new String(o("animation")), t.support.animation.end = l.animation.end[t.support.animation]), h() && (t.support.transform = new String(o("transform")), t.support.transform3d = u())
}(window.Zepto || window.jQuery, window, document),
function () {
    "use strict";
...
function (t) {
    ...
    function e() {
        ...
        t(".gallery").each((function () {
            ...
            i.append('<div class="gallery_wrap"></div>'), i.children("img").each((function () {
                t(this).appendTo("#" + n + " .gallery_wrap")
            })), i.find(".gallery_wrap img").each((function () {
                var e = t(this).attr("src");
                t(this).wrapAll('<div class="gallery_item"><a href="' + e + '" class="gallery_item_link"></div></div>').appendTo()
            })), i.imagesLoaded((function () {
                if ("1" === s) {
                    i.addClass("gallery-carousel"), i.children(".gallery_wrap").addClass("owl-carousel"), i.children(".gallery_wrap").owlCarousel({
                        items: 1,
                        loop: !0,
                        mouseDrag: !1,
                        touchDrag: !0,
                    ...
                    var t = new Waypoint({
                            ...
                            handler: function (t) {
                                "down" === t && i.children(".gallery_wrap").trigger("stop.owl.autoplay"), "up" === t && i.children(".gallery_wrap").trigger("play.owl.autoplay")
                            },
                            offset: "-100%"
                        }),
                        e = new Waypoint({
                            element: document.getElementById(n),
                            handler: function (t) {
                                "down" === t && i.children(".gallery_wrap").trigger("play.owl.autoplay"), "up" === t && i.children(".gallery_wrap").trigger("stop.owl.autoplay")
                            },
                            offset: "100%"
                        })
                } else i.addClass("gallery-grid"), i.children(".gallery_wrap").masonry({
                    itemSelector: ".gallery_item",
                    transitionDuration: 0
                }), i.find(".gallery_item_link").fluidbox({
                    loader: !0
                });
    ...
    var i = t("body").attr("data-page-url"),
        n = document.title,
        s = window.History,
        o = t(".page_content").attr("data-image");
    s.Adapter.bind(window, "statechange", (function () {
        var r = s.getState();
        t("body").addClass("loading"), t(".page-loader").load(r.hash + " .page_content", (function () {
            var s = 400;
            setTimeout((function () {
                t("body, html").animate({
                    scrollTop: 0
                }, 0), t(".page .page_content").remove(), t(".page-loader .page_content").appendTo(".page"), t("body").attr("data-page-url", window.location.pathname), i = t("body").attr("data-page-url"), n = t(".page_content").attr("data-page-title"), document.title = n;
                var s = t(".page_content").attr("data-image");
                e(), s !== o && (o = s, t(".header-image:not(.header-image-on)").css("background-image", "url(" + o + ")"), t(".header-image:not(.header-image-on)").addClass("header-image-switch"), t(".header-image-switch").imagesLoaded({
                    background: !0
                }, (function () {
                    t(".header-image-on").removeClass("header-image-on"), t(".header-image-switch").addClass("header-image-on"), t(".header-image-switch").removeClass("header-image-switch")
                })))
            }), 400)
        }))
        ...
        t(this).hasClass("js-no-ajax") || o.indexOf("#") >= 0 || o.indexOf("mailto:") >= 0 || o.indexOf("tel:") >= 0 ? window.location = o : t(this).is(".gallery_item_link") || (o.indexOf("http") >= 0 ? window.open(o, "_blank") : (i = o, s.pushState(null, n, o)))
    ...
    })), t(document).on("click", ".menu_list_item_link", (function () {
        t(".menu").hasClass("menu-open") && t(".menu").removeClass("menu-open")
    })), t(document).on("submit", "#contact-form", (function (e) {
        t(".contact-form_item-error").removeClass("contact-form_item-error");
        var i = t('.contact-form_input[name="email"]'),
            n = t('.contact-form_input[name="name"]'),
            s = t('.contact-form_textarea[name="message"]'),
            o = t(".contact-form_gotcha");
        "" === i.val() && i.closest(".contact-form_item").addClass("contact-form_item-error"), "" === n.val() && n.closest(".contact-form_item").addClass("contact-form_item-error"), "" === s.val() && s.closest(".contact-form_item").addClass("contact-form_item-error"), "" !== i.val() && "" !== n.val() && "" !== s.val() && 0 === o.val().length || e.preventDefault()
    }))
}(jQuery);